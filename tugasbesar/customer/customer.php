    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../barang/barang.php"> Barang </a>
          </li>
          <li class="nav-item">
...
<div class="card"><!-- PEMBUKA CARD -->
  ...
  <br>
  <div class="card-body">
  <a href="registasicustomer.php"> <button type="button" style="width: 20%; border-radius: 8px;" class="btn btn-outline-primary">Tambah Customer</button></a>
  ...
  <table class="table-responsive w-full rounded">
    <thead style= " background-color: #45103E !important;";>
        ...
        <th class="border w-1/5 px-4 py-2"> No_Telepon </th>
        </tr>
    </thead>
    <tbody>
                    <?php while ($data = mysqli_fetch_assoc($customer)): ?>
                        <tr>
                            <td class="border px-4 py-2"><?php echo $data['id_customer']; ?></td>
                            <td class="border px-4 py-2"><?php echo $data['Nama_C']; ?></td>
                            <td class="border px-4 py-2"><?php echo $data['No_telepon']; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
</table>
